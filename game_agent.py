...
def isEndGame(game): # check end status
...
def custom_score(game, player):
    ...
    return float(abs(y1-y2)+abs(x1-x2)+own_moves**2 - opp_moves)
...
def custom_score_2(game, player):
    ...
    return float(abs(y1-y2)+abs(x1-x2))
...
def custom_score_3(game, player):
    ...
    return float(15-abs(y1-y2)+abs(x1-x2))
...
def custom_score_5(game, player):
    ...
    return float(abs(y1-y2)+abs(x1-x2)+own_moves - opp_moves)
...
class AlphaBetaPlayer(IsolationPlayer):
    ...
    def min_value(self,game, depth,a,b):
        ...
        if isEndGame(game) or depth ==0:
            ...
            for m in game.get_legal_moves():
                v = min(v, self.max_value(game.forecast_move(m),depth-1,a,b))
                if v<=a:
                    return v
                b=min(v,b)
    ...
    def max_value(self,game, depth,a,b):
        ...
        if isEndGame(game) or depth ==0 :
            ...
            for m in game.get_legal_moves():
                v = max(v, self.min_value(game.forecast_move(m),depth-1,a,b))
                if v>=b:
                    return v
                a=max(a,v)
